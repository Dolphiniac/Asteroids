...
struct Layer
{
	void Add(RendererInterface* renderable) { renderables.insert(renderable); }
	void Remove(RendererInterface* renderable) { renderables.erase(renderable); }
	...
	std::set<RendererInterface*> renderables;
	~Layer()
	{
		for (RendererInterface* renderable : renderables)
		{
